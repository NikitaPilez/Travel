...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $dataRow = $this->dataRow($postDataType, 'header');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text_area',
                'display_name' => 'Header',
        ...
        $dataRow = $this->dataRow($commentDataType, 'comment_belongsto_user_relationship');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'relationship',
                'display_name' => 'User',
        ...
        $dataRow = $this->dataRow($commentDataType, 'user_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'select_dropdown',
                'display_name' => 'User Id',
        ...
        $dataRow = $this->dataRow($commentDataType, 'comment_belongsto_post_relationship');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'relationship',
                'display_name' => 'Post',
        ...
        $dataRow = $this->dataRow($commentDataType, 'post_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'select_dropdown',
        ...
        $dataRow = $this->dataRow($commentDataType, 'body');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'rich_text_box',
                'display_name' => 'Body',
        ...
        $dataRow = $this->dataRow($commentDataType, 'status');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Status',
